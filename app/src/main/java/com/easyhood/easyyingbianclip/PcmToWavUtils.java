...
public class PcmToWavUtils {
    private static final String TAG = "PcmToWavUtils";
    private int mBufferSize; // 缓存的音频大小
    private int mSampleRate = 8000; // 8000|16000 以赫兹表示采样率
    private int mChannelConfig = AudioFormat.CHANNEL_IN_STEREO; // 立体声
    private int mChannelCount = 2; //声道数
    private int mEncoding = AudioFormat.ENCODING_PCM_16BIT; // 音频格式

    /**
     * 构造方法 无参
     */
    public PcmToWavUtils() {
     ...
     * @param encoding 音频格式
     */
    public PcmToWavUtils(int sampleRate, int channelConfig, int channelCount, int encoding) {
